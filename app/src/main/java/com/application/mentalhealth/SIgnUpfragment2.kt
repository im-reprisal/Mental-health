...
import kotlinx.android.synthetic.main.fragment_s_ign_upfragment2.*
...
class SIgnUpfragment2 : Fragment(R.layout.fragment_s_ign_upfragment2) {
            ...
            .addOnCompleteListener{ task ->
                if (task.isSuccessful) {
                    ...
                    Navigation.findNavController(requireView())
                        .navigate(R.id.action_SIgnUpfragment2_to_emptyActivity)
